...
using Univap.Programacao3.Engine.Engine.Interface;
using Univap.Programacao3.Engine.Model;
using static System.Windows.Forms.VisualStyles.VisualStyleElement.StartPanel;

namespace Univap.Programacao3.Engine
{
    public class FormEngine : MetroForm
    {
        protected void CloseAllTabs(TabControl tabControl)
        {
            while (tabControl.TabPages.Count > 0)
                tabControl.TabPages.RemoveAt(0);
        }

        protected Form CreateMdiForm(Form form)
        {
